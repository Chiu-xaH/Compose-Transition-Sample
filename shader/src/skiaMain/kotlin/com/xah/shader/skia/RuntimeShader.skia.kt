...
actual fun RuntimeShader(
    ...
    return SkiaRuntimeShader(shader)
}

actual fun RuntimeShader.asComposeShader(): Shader {
    return this.asSkiaRuntimeShader().makeShader()
}

fun RuntimeShader.asSkiaRuntimeShader(): RuntimeShaderBuilder {
    return (this as SkiaRuntimeShader).shader
}

internal class SkiaRuntimeShader(val shader: RuntimeShaderBuilder) : RuntimeShader {
